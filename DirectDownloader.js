    ...
    run() {
        ...
        const createDialog = () => {
            ...
            style.textContent = `
                ...
                .dub-select { width: 80%; margin: auto 0; display: block; padding: 8px; background: #191919; color: #e1e1e1; border: 1px solid #1e1e1e; border-radius: 4px; font-family: inherit; cursor: pointer; }
            ...
            return { dialog, backdrop, switchButton, videoOptions, audioOptions, qualityOptions, downloadButton, bitrateOptions, downloadStatus, cancelButton, dubSelector, dubSelect };
        };

        const updateQualityOptions = (dialog, codec, savedQuality) => {
            const qualityOptions = dialog.querySelector("#quality-options");
            qualityOptions.innerHTML = '';
            const qualities = codec === "h264" ? ["144p", "240p", "360p", "480p", "720p", "1080p"] :
                             codec === "vp9" ? ["144p", "240p", "360p", "480p", "720p", "1080p", "1440p", "4k"] :
        ...
        const interceptDownload = () => {
            const { dialog, backdrop, switchButton, videoOptions, audioOptions, qualityOptions, downloadButton, bitrateOptions, downloadStatus, cancelButton, dubSelector, dubSelect } = createDialog();
            ...
            downloadButton.addEventListener("click", () => {
                ...
                if (isAudioMode) {
                    const payload = {
                        ...
                        ...(config.audioCodec !== "wav" && { audioBitrate: dialog.querySelector("input[name='bitrate']:checked")?.value || "320kbps" })
                    };
            ...
            <div class="module-config">
                ...
                <label>Audio Codec:
                    <select class="config-audioCodec">
                        ...
                        <option value="aac" ${config.audioCodec === "aac" ? "selected" : ""}>AAC</option>
